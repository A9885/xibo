...
/* licence.twig */
class __TwigTemplate_3437dc9214a8e56d6394d1a57d10e83a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        yield "<h2>Xibo <small> - Simple. Intuitive. Impactful. Secure.</small></h2>
<p>Xibo Digital Signage - <a target=\"_blank\"  href=\"https://xibosignage.com\" title=\"Xibo Website\">xibosignage.com</a>.<br/>
    ...
    Copyright &copy 2006-";
        ...
        yield " Xibo Signage Ltd and the
...
<p>
    Version ";
        ...
        yield "<br/><span class=\"badge badge-info\">SHA:";
...
<p>Further guidance is available <a href=\"https://xibosignage.com/eula\">here</a>. If in doubt, please seek professional legal advice.</p>
...
<p>As an end user of the Xibo software you are entitled to download and view the source code. You may do
    so from <a target=\"_blank\"  id=\"source-link\" href=\"";
        // line 29
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["sourceUrl"] ?? null), "html", null, true);
        yield "\">GitHub</a>.
...
";
        // line 55
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["theme"] ?? null), "getThemeConfig", ["app_name"], "method", false, false, false, 55) == "Xibo")) {
            // line 56
            yield "<h2>Feedback</h2>
<p>Feedback can be submitted via the help button and feedback forms contained within the CMS. Feedback helps us improve our products and services. When you submit feedback, we collect your name and email address, along with your comments and any attachments. This information is used and stored in accordance with our <a href=\"https://xibosignage.com/privacy\">privacy policy</a> and <a href=\"https://xibosignage.com/dpa\">data processing agreement</a>.</p>
";
        }
        // line 59
        yield "
...
";
    ...
    {
        return array (  112 => 59,  107 => 56,  105 => 55,  76 => 29,  50 => 8,  43 => 4,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "licence.twig", "/var/www/xibo/views/licence.twig");
    }
}
