...
class __TwigTemplate_b02ce75405de2278442628fa6f57b4fa extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <script type=\"text/x-handlebars-template\" id=\"android-dimension-fields\">
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Top"), "html", null, true);
        // line 379
        yield "\"></input>
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Left"), "html", null, true);
        // line 380
        yield "\"></input>
            <input type=\"number\" value=\"{{ width }}\" class=\"col-3 form-control androidDimensionInput\" min=\"0\" name=\"dimensionWidth\" id=\"dimensionWidth\" placeholder=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Width"), "html", null, true);
        // line 381
        yield "\"></input>
            <input type=\"number\" value=\"{{ height }}\" class=\"col-3 form-control androidDimensionInput\" min=\"0\" name=\"dimensionHeight\" id=\"dimensionHeight\" placeholder=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(__("Height"), "html", null, true);
        // line 385
        yield "\"></input>
...
";
    ...
    {
        return array (  424 => 385,  420 => 381,  416 => 380,  412 => 379,  404 => 378,  400 => 372,  386 => 371,  382 => 360,  335 => 359,  38 => 23,);
    }

    public function getSourceContext()
    {
        return new Source("", "displayprofile-form-edit-javascript.twig", "/var/www/xibo/views/displayprofile-form-edit-javascript.twig");
    }
}
